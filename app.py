...
def convert_docx_to_pdf():
    """
    Converts a Word document (.docx) to a PDF file using LibreOffice.

    Returns:
        JSON response or a downloadable PDF file.
    """
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            output_path = os.path.join(tmp_dir, f"{os.path.splitext(file.filename)[0]}.pdf")
        ...
        return jsonify({"error": "Error during file conversion. Please try again."}), 500
